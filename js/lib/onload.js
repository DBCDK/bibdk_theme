...
(function ($) {
  ...
  onLoad = {
    setFocus: function() {
      ...
      // User login form
      $('form#user-login').find('input[type=text],input[type=email], textarea').filter(':visible:first').focus();
      // Create new account
      $('form#user-register-form').find('input[type=text],input[type=email], textarea').filter(':visible:first').focus();
      // Request new password
      $('form#user-pass').find('input[type=text],input[type=email], textarea').filter(':visible:first').focus();
      // User help popup
