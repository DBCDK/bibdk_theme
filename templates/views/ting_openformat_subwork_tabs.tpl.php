...
<div class="tabs-nav-sub clearfix">
  ...
  <?php foreach ($typesarray as $type => $subtypes) : $outercounter++ ?>
    <?php $innercounter = 0; ?>
    <div id="<?php print $type ?><?php print $ding_id; ?>" class="<?php print ($outercounter != 1) ? "visuallyhidden" : ""  ?>">
      <?php foreach ($subtypes as $subtype) : $innercounter++ ?>
        <a href="#<?php print $subtype[0]; ?><?php print $ding_id; ?>" class="<?php print ($innercounter == 1) ? "active" : ""  ?>"><?php print $subtype[1]; ?> (<?php print $subtype[2]; ?>)</a>
      <?php endforeach; ?>
    </div>
  <?php endforeach; ?>
</div>
