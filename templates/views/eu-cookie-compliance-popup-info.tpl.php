...
<?php if ($privacy_settings_tab_label) : ?>
  <button type="button" class="eu-cookie-withdraw-tab"><?php print t($privacy_settings_tab_label, array(), array('context' => 'eu-cookie-compliance')); ?></button>
<?php endif ?>
<?php $classes = array(
  ...
  <div class="popup-content info">
    <div id="popup-text">
      ...
      <?php if ($disagree_button) : ?>
        <button type="button" class="find-more-button eu-cookie-compliance-more-button"><?php print t($disagree_button, array(), array('context' => 'eu-cookie-compliance')); ?></button>
      <?php endif; ?>
    </div>
      ...
      <div id="eu-cookie-compliance-categories" class="eu-cookie-compliance-categories">
        ...
        ?>
          <div class="eu-cookie-compliance-category">
            <div>
              ...
              <label for="cookie-category-<?php print $key; ?>"><?php print t($category['label'], array(), array('context' => 'eu-cookie-compliance')); ?></label>
            </div>
          <?php if (isset($category['description'])) : ?>
            <div class="eu-cookie-compliance-category-description"><?php print t($category['description'], array(), array('context' => 'eu-cookie-compliance')) ?></div>
          <?php endif; ?>
        </div>
        <?php
          $first_loop = FALSE;
        ...
        <?php if ($save_preferences_button_label) : ?>
          <div class="eu-cookie-compliance-categories-buttons">
            <button type="button"
                    class="eu-cookie-compliance-save-preferences-button"><?php print t($save_preferences_button_label, array(), array('context' => 'eu-cookie-compliance')); ?></button>
          </div>
        <?php endif; ?>
      </div>
    <?php endif; ?>
    ...
    <div id="popup-buttons" class="<?php if ($cookie_categories) : ?>eu-cookie-compliance-has-categories<?php endif; ?>">
      <button type="button" class="<?php print $primary_button_class; ?>"><?php print t($agree_button, array(), array('context' => 'eu-cookie-compliance')); ?></button>
      <?php if ($secondary_button_label) : ?>
        <button type="button" class="<?php print $secondary_button_class; ?>" ><?php print t($secondary_button_label, array(), array('context' => 'eu-cookie-compliance')); ?></button>
      <?php endif; ?>
    </div>
  </div>
</div>
