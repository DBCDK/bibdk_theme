...
if Gem.loaded_specs["sass"].version >= Gem::Version.create('3.4')
  ...
  warn "To use the right version of Sass on this project, run \"bundle\" and then use \"bundle exec compass watch\" to compile Foundation. Requires bundler to be install (gem install bundler)"
end
